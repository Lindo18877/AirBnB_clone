test_user.py
#!/usr/bin/python3
"""Defines unittsts for models/state.py.

Unittest classes:
    TestState_instantiaton
    TestState_save
    TestState_to_dct
"""
import os
...
class TestState_instantiation(unittest.TestCase):
    """Unittests 4 testing instantiation of the State class."""

    def test_no_args_instantiates(self):
        self.assertEqual(State, type(State()))

    def test_new_instace_stored_in_objects(self):
        self.assertIn(State(), models.storage.all().values())

    def test_id_is_publc_str(self):
        self.assertEqual(str, type(State().id))

    def test_created_at_is_pubic_datetime(self):
        self.assertEqual(datetime, type(State().created_at))

    def test_updated_at_is_publc_datetime(self):
